...
$(function() {
    $.contextMenu({
		...
		items: {
            "insertCR": {name: "Spalte rechts einfügen", icon: "fas fa-arrow-right"},
            "insertCL": {name: "Spalte links einfügen", icon: "fas fa-arrow-left"},
            "deleteC": {name: "Spalte löschen", icon: "fas fa-trash-alt"},
            "sep1": "---------",
            "insertRD": {name: "Zeile unten einfügen", icon: "fas fa-arrow-down"},
            "insertRU": {name: "Zeile oben einfügen", icon: "fas fa-arrow-up"},
            "deleteR": {name: "Zeile löschen", icon: "fas fa-trash-alt"},
            "sep3": "---------",
            "duplicateRow": {name: "Zeile duplizieren", icon: "fas fa-clone"},
            "sep4": "---------",
            "copyRow": {name: "Zeile kopieren", icon: "fas fa-arrows-alt-h"},
            "pasteRow": {name: "Kopierte Zeile unten einfügen", icon: "fas fa-arrows-alt-h"},
        }
        /*items: {
